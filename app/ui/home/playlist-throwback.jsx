...
export default function PlaylistThrowback({ card , link }  ) {
  ...
  return (
    <div className="w-full px-1 py-2 md:p-2 my-8  overflow-hidden" id="boxes_1">
      <h3 className="text-lg font-[500]">New Release</h3>
      <div className="w-full flex items-center justify-center">
        <div className="mx-1 hidden md:block opacity-0 cursor-pointer" id="small_boxes_1" onClick={()=>handleSlide('prev')}>
        ...
        <div className="mx-1 hidden md:block opacity-0 cursor-pointer" id="small_boxes_1" onClick={()=>handleSlide('next')}>
